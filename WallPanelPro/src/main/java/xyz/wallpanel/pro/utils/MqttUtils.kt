...
class MqttUtils {
    companion object {
        ...
        const val STATE_ANDROID_VERSION = "androidVersion"
        const val STATE_APP_VERSION = "appVersion"
        const val STATE_DEVICE_OWNER = "deviceOwner"
        const val STATE_IP_ADDRESS = "ipAddress"
        const val STATE_MANUFACTURER = "manufacturer"
        const val STATE_MODEL = "model"
        const val STATE_SCREEN_SAVER = "screenSaver"
        const val STATE_STORAGE_FREE = "storageFree"
        const val STATE_UPTIME = "uptime"
        const val STATE_VOLUME = "volume"
        const val STATE_WIFI_SIGNAL = "wifiSignal"
        const val STATE_WIFI_SSID = "wifiSsid"
